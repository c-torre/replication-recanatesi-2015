#%%
from recall_performance import data_build, memory_intersections
import numpy as np
import pandas as pd
...
transition_memories = pd.Series(
    [sorted(transition) for transition in zip(before_jumps, after_jumps)], name="transition_memories"
)
