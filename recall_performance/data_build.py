...
from recall_performance import data_loader
...
# Data load and clean
SEEDS_RESULTS_DIR = os.path.join(RESULTS_DIR, "seeds")


recalls_data_frames = data_loader.get_cleaned_frames(SEEDS_RESULTS_DIR)


# Avoid 0/0 error with hacky sum later
EPSILON = 0.000000001
